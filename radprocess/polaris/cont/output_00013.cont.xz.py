...
os.system('rm -rf output_00013.cont.xz.cmd')
with open('output_00013.cont.xz.cmd', 'w') as f:
    # <common>
    f.write('<common>\n')
    ...
    wave = 0.9 * u.mm
    dist = 250 * u.pc
    f.write('\n\t<detector_dust nr_pixel = "%d"> %e %e 1 1 90 0 %e\n'
...
os.system('rm -rf xz/')
os.system('polaris output_00013.cont.xz.cmd')

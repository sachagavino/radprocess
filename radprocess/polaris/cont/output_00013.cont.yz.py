...
os.system('rm -rf output_00013.cont.yz.cmd')
with open('output_00013.cont.yz.cmd', 'w') as f:
    # <common>
    f.write('<common>\n')
    ...
    wave = 0.9 * u.mm
    dist = 250 * u.pc
    f.write('\n\t<detector_dust nr_pixel = "%d"> %e %e 1 1 90 90 %e\n'
    ...
    f.write('\n\t<write_3d_midplanes> 2 %d\n' % npix)

    f.write('\n</task>')

os.system('rm -rf yz/')
os.system('polaris output_00013.cont.yz.cmd')
